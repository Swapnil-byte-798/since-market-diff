  ...
  return (
    <div className="py-12">
      ...
      <p className="mt-2 max-w-prose text-[0.8rem] text-ink-faint">
        ...
        Start them with <code className="font-mono">npm run api</code> and <code className="font-mono">npm run ingest</code>.
      </p>
      {onRetry ? (
  ...
  return (
    <div className="mt-6 border-l-2 border-signal bg-signal-soft/40 px-4 py-3">
      <p className="text-[0.75rem] leading-relaxed text-ink-muted">
        ...
        The live NSE feed was rate-limited during ingestion, so this is deterministic generated
        market data — reproducible from a seed, and never presented as live. Re-run{' '}
